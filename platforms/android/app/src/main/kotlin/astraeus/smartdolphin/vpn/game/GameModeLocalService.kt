...
class GameModeLocalService : Service() {
    ...
    /** Report game state without holding a CPU wake lock. The game itself and
     * the VPN foreground service already define the required process lifetime. */
    ...
    private fun releaseAccelHints() = Unit
