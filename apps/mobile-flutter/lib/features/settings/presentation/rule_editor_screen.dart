...
class _RuleEditorScreenState extends ConsumerState<RuleEditorScreen>
  ...
  String _fileTitle() {
    ...
    final dbName = ref.read(settingsControllerProvider).routing.ruleDb.savedRuleName;
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      safeSetState(() {
        _saving = false;
        _compileErrors = [
          SdrlDiagnostic(severity: 'error', code: 'E000', message: e.toString()),
        ];
      });
    }
  }
      ...
      return await showDialog<String>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: TextField(
            ...
            onSubmitted: (_) => Navigator.of(ctx).pop(nameController.text.trim()),
          ),
          actions: [
            TextButton(
                  ...
                  child: Row(
                    children: [
                      TextButton(
                        ...
                        child: Text(docLabel, style: const TextStyle(fontSize: 12)),
                      ),
                      const Spacer(),
                      FilledButton(
                        ...
                        onPressed: onDismiss,
                        child: Text(closeLabel, style: const TextStyle(fontSize: 12)),
                      ),
                    ],
                  ),
                ),
