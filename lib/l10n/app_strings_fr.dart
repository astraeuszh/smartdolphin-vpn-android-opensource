...
const Map<String, String> kAppStringsFr = {
  ...
  'authLegalAgreementHint': 'En vous connectant ou en vous inscrivant, vous confirmez avoir lu et accepté {agreements}.',
  ...
  'privacyPolicySectionRetentionBody': 'SmartDolphinVPN conserve un minimum de journaux sur votre appareil pendant 7 jours maximum pour résoudre les problèmes de performances, à moins que vous ne les supprimiez plus tôt.',
  ...
  'privacyPolicySectionSharingVendorsBody': 'Si vous choisissez de signaler des plantages ou de contacter l\'assistance, nous pouvons faire appel à des sous-traitants qui sont contractuellement tenus de protéger ces informations et de les utiliser uniquement pour nous aider.',
  ...
  'sessionElapsedLabel': 'En cours {duration}',
  'sessionUnitDay': '{n} j',
  'sessionUnitHour': '{n} h',
  ...
  'settingsPreciseSessionTimer': 'Afficher l’heure précise',
  'settingsPreciseSessionTimerSubtitle':
      'Format : jours, heures, minutes, secondes et millisecondes',
  ...
  'speedTestBenchmarking': 'Benchmark de votre tunnel sécurisé…',
