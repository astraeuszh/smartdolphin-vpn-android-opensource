...
class HiVpnGlass {
  ...
  static const Color tint = Color(0x26FFFFFF);
  static const Color tintNav = Color(0x33FFFFFF);
  static const Color tintSheet = Color(0xFFFAFAFA);
  ...
  static const Color fillStrong = Color(0x40FFFFFF);
